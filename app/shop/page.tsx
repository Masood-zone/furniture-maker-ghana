      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex justify-center mb-8 space-x-4">
          <button
            ...
            className={`px-4 py-2 rounded-full ${
              filter === 'all' ? 'bg-amber-600 text-white' : 'bg-gray-200 text-gray-700'
            }`}
          >
            All Products
          </button>
          <button
            ...
            className={`px-4 py-2 rounded-full ${
              filter === 'chairs' ? 'bg-amber-600 text-white' : 'bg-gray-200 text-gray-700'
            }`}
          >
            Chairs
          </button>
          <button
            ...
            className={`px-4 py-2 rounded-full ${
              filter === 'tables' ? 'bg-amber-600 text-white' : 'bg-gray-200 text-gray-700'
            }`}
          >
            Tables
          </button>
          <button
            ...
            className={`px-4 py-2 rounded-full ${
              filter === 'sets' ? 'bg-amber-600 text-white' : 'bg-gray-200 text-gray-700'
            }`}
          >
            Sets
          </button>
        ...
        <div className="mt-16 bg-blue-50 p-8 rounded-lg">
          ...
          <p className="text-gray-600 mb-6">
            We accept custom orders for unique pieces tailored to your specific needs. 
            Our artisans can work with you to create the perfect piece for your space.
          </p>
          <Link 
            href="/contact"
